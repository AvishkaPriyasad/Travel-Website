...
import { Bus, Hotel, Map, Camera, Headphones, Shield } from "lucide-react";

const Features = () => {
  const features = [
    {
      icon: <Bus className="h-8 w-8 mb-2 text-primary" />,
      title: "Exclusive Transport Deals",
      description:
        "Access to premium and discounted vehicles for your journey.",
    },
    {
